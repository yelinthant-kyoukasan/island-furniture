...
<script>\
    document.addEventListener("DOMContentLoaded", function(){\
        ...
        document.getElementById("favouriteProducts").setAttribute("href", "/B/' + countryPrefix + '/favouriteProducts.html");\
        }, false);\
    function logout() {\
        ...
        <div class="container">\
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    ...
                    <li>\
                        <li><a id="favouriteProducts"><i class="icon icon-heart"></i> Favourites</a></li>\
                    </li>\
                </ul>\
            </nav>\
        </div>\
